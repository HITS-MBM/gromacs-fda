...
/// Dummy class for C kernels
struct FDA {};

/// For C kernels
/// Must be identical to InteractionType.h
#define InteractionType_COULOMB 0x10
#define InteractionType_LJ 0x20
 ...
 * computed, the same way it's done in the nonbonded kernels
 */
void fda_add_nonbonded_single(struct FDA *fda, int i, int j, int type, real force, real dx, real dy, real dz);
