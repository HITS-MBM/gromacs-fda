...
void pf_atom_add_bonded_nocheck(struct t_pf_global *pf_global, int i, int j, int type, rvec force);
 ...
 */
void pf_atom_virial_bond(struct t_pf_global *pf_global, int ai, int aj, real fbond, real dx, real dy, real dz);
