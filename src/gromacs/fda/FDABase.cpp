...
template <class Base>
void FDABase<Base>::write_frame(rvec *x, const matrix box, int nsteps)
{
...
template <class Base>
void FDABase<Base>::write_frame_detailed(rvec *x, const matrix box, bool print_vector, int nsteps)
{
...
template <class Base>
void FDABase<Base>::write_frame_summed(rvec *x, const matrix box, bool print_vector, int nsteps)
{
    result_file << "frame " << nsteps << std::endl;
    if (print_vector)
...
template <class Base>
void FDABase<Base>::write_frame_summed_compat(rvec *x, const matrix box, int nsteps)
{
    if (result_type == ResultType::COMPAT_ASCII) {
        result_file << "<begin_block>" << std::endl;
        result_file << nsteps << std::endl;
