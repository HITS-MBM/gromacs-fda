...
void pf_interaction_array_summed_append(t_pf_interaction_array_summed *ia, int jjnr, int type, rvec force) {
 ...
 */
void pf_atom_summed_add(t_pf_atom_summed *atom, int jjnr, int type, rvec force) {
