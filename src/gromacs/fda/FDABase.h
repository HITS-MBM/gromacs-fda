...
public:
    ...
    void write_frame(rvec *x, const matrix box, int nsteps);

    void write_frame_detailed(rvec *x, const matrix box, bool print_vector, int nsteps);

    void write_frame_summed(rvec *x, const matrix box, bool print_vector, int nsteps);
    ...
    void write_frame_summed_compat(rvec *x, const matrix box, int nsteps);
